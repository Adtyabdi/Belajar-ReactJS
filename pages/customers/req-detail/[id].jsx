      ...
      <section className="w-full mr-6">
        <nav>
          <div className="flex my-4 justify-between">
            <h1 className="font-bold text-3xl ">Request Detail </h1>
            <div className="flex">
          ...
          <div className="flex my-11">
            <div className="flex mr-32 gap-5">
              ...
              <div>
                <p className="font-semibold text-lg">JC Store</p>
        ...
        <div className="relative z-10">
          ...
          <div className="flex justify-end mt-4">
            <button
              ...
              id="incomplate"
            >
              <span className="mr-2" id="incomplate">
                Denied
              </span>{" "}
              <IoClose size={20} />
            </button>
            <button
              ...
              id="complate"
            >
              <span className="mr-2">Accept</span> <FaCheck size={20} />
            </button>
          </div>
        </div>
      </section>
