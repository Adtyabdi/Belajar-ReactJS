      ...
      <section className="w-full mr-6">
        <nav>
          <div className="flex my-4 justify-between">
            <h1 className="font-bold text-3xl ">Outgoing Goods Detail </h1>
            <div className="flex">
        ...
        <div>
          <table className="w-full table text-left">
            ...
            <tbody>
              {dataUser.map((item) => (
                <tr key={item.id} className="border-b-2 mb-5">
                  <td className="py-3 font-bold">{item.brand}</td>
                  <td>x{item.quantity}</td>
                </tr>
              ))}
              <tr className="border-b-2 mb-5">
                <td className="py-3 font-bold text-center">Total</td>
                <td>
                  {dataUser.reduce((total, item) => total + item.quantity, 0)}
                </td>
              </tr>
            </tbody>
          </table>
